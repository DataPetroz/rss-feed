...
from config.settings import RSS_FEEDS, FEED_CACHE_TTL
...
def display_article_card(article: dict, index: int):
    ...
    with col2:
        # ✅ NUOVO APPROCCIO: usa st.switch_page con oggetto Page
        if st.button("📊 Elabora", key=f"elabora_{article_id}_{index}", use_container_width=True, type="primary"):
            ...
            # ✅ Switch alla pagina elaborazione
            st.switch_page("pages/elaborazione.py")
